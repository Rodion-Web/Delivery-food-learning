      ...
      <div class="products-wrapper">
        <div class="product-card">
          <div class="product-card__image">
            <img src="../assets/images/goods/good-1.jpg" alt="good-1.jpg" />
          </div>
        ...
        <div class="product-card">
          <div class="product-card__image">
            <img src="../assets/images/goods/good-2.jpg" alt="good-2.jpg" />
          </div>
          <div class="product-card__description">
            <div class="product-card__description-row">
              <h5 class="product-card__description--name">
        ...
        <div class="product-card">
          <div class="product-card__image">
            <img src="../assets/images/goods/good-3.jpg" alt="good-3.jpg" />
          </div>
          <div class="product-card__description">
            <div class="product-card__description-row">
              <h5 class="product-card__description--name">
        ...
        <div class="product-card">
          <div class="product-card__image">
            <img src="../assets/images/goods/good-4.jpg" alt="good-4.jpg" />
          </div>
          <div class="product-card__description">
            <div class="product-card__description-row">
              <h5 class="product-card__description--name">
        ...
        <div class="product-card">
          <div class="product-card__image">
            <img src="../assets/images/goods/good-5.jpg" alt="good-5.jpg" />
          </div>
          <div class="product-card__description">
            <div class="product-card__description-row">
              <h5 class="product-card__description--name">
        ...
        <div class="product-card">
          <div class="product-card__image">
            <img src="../assets/images/goods/good-6.jpg" alt="good-6.jpg" />
          </div>
          <div class="product-card__description">
            <div class="product-card__description-row">
              <h5 class="product-card__description--name">
